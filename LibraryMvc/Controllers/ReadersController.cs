...
namespace LibraryMvc.Controllers
{
    public class ReadersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ReaderId,FullName,Phone,Email")] Reader reader)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReaderId,FullName,Phone,Email")] Reader reader)
        {
